...
namespace GuestFlow.Persistence.Migrations
{
    ...
    [Migration("20251212125750_AddNewFieldsToEntities")]
    partial class AddNewFieldsToEntities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GuestFlow.Domain.Entities.Core.SettingEntity", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            CreatedDate = new DateTime(2025, 12, 12, 15, 57, 49, 853, DateTimeKind.Local).AddTicks(2772),
                            IsDeleted = false,
            ...
            modelBuilder.Entity("GuestFlow.Domain.Entities.Core.TourEntity", b =>
                {
                    b.HasOne("GuestFlow.Domain.Entities.Core.CityEntity", null)
                        .WithMany("Tours")
